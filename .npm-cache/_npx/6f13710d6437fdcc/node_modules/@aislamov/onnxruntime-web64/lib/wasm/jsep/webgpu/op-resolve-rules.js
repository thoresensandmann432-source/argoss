...
const attentiion_1 = require("./ops/attentiion");
const bias_add_1 = require("./ops/bias-add");
const bias_split_gelu_1 = require("./ops/bias-split-gelu");
...
const gather_elements_1 = require("./ops/gather-elements");
...
const multi_head_attentiion_1 = require("./ops/multi-head-attentiion");
...
exports.WEBGPU_OP_RESOLVE_RULES = new Map([
    ...
    ['Attention', [attentiion_1.attention, attentiion_1.parseAttentionAttributes]],
    // TODO: support new attributes for AveragePool-10
    ['AveragePool', [pool.averagePool, pool.parseAveragePoolAttributes]],
    ['Cast', [unaryOps.cast, unaryOps.parseCastAttributes]],
    ['BiasAdd', [bias_add_1.biasAdd]],
    ['BiasSplitGelu', [bias_split_gelu_1.biasSplitGelu]],
    ['Ceil', [unaryOps.ceil]],
    ...
    ['GatherElements', [gather_elements_1.gatherElements, gather_elements_1.parseGatherElementsAttributes]],
    ['Gelu', [unaryOps.gelu]],
    ...
    ['Mul', [binaryOps.mul]],
    ['MultiHeadAttention', [multi_head_attentiion_1.multiHeadAttention, multi_head_attentiion_1.parseMultiHeadAttentionAttributes]],
    ['Neg', [unaryOps.neg]],
    ['Not', [unaryOps.not]],
    ['Pow', [binaryOps.pow]],
